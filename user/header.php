...
<html lang="id">
  <head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" integrity="sha512-9usAa3IW2lEnf3lGY6i7IeJCN7fcExXuhq+accesswqZ+20UblT+y23I5LvW12KL6DMLA51a+R1mk/PT0iNbFF0Q==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    
    <!-- Custom CSS -->
    <link rel="stylesheet" href="assets/css/style.css">

    <title>E-Arsip | User - Sistem</title>
  </head>
  <body>
    <!-- Navbar -->
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userMenu">
                            ...
                            <a class="dropdown-item" href="?halaman=pengaturan">
    ...
    <div class="sidebar collapsed" id="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="sidebar-menu-item">
                <a class="sidebar-menu-link" href="?halaman=balasan_surat">
                    <i class="fas fa-envelope-open-text"></i>
                    <span>Balasan Surat</span>
                </a>
            </li>
        </ul>
        ...
        <div class="sidebar-user">
            ...
            <div class="sidebar-user-role">User Biasa</div>
        </div>
